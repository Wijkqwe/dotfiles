...
hi Comment cterm=NONE ctermfg=26
hi LineNr cterm=NONE ctermfg=6
hi MatchParen cterm=NONE ctermfg=0 ctermbg=14
hi Number cterm=NONE ctermfg=12
hi String cterm=NONE ctermfg=69
hi vimCommand cterm=NONE ctermfg=39
hi vimOper cterm=NONE ctermfg=12
" hi Statement cterm=NONE ctermfg=51 

hi cBlock cterm=NONE ctermfg=14
hi cConditional cterm=NONE ctermfg=12
hi link cCharacter cString
hi link cDefine cInclude
hi cFormat cterm=NONE ctermfg=39
hi cInclude cterm=NONE ctermfg=38
hi cNumber cterm=NONE ctermfg=12
hi cParen cterm=NONE ctermfg=45
hi cRepeat cterm=NONE ctermfg=12
hi cString cterm=NONE ctermfg=69
hi cSpecial cterm=NONE ctermfg=39
hi cStorageClass cterm=NONE ctermfg=38
hi link cStructure cType
hi cType cterm=NONE ctermfg=38

hi link confString cString

hi link fsDeviceUUID Number
hi link fsOptionsString String

" hi link gitignorePattern
